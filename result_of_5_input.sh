...
cat input_files/input1.in | mvn exec:java > ../verificator-projet3-ps5/resultat/Result_input1.txt
...
cat input_files/input2.in | mvn exec:java > ../verificator-projet3-ps5/resultat/Result_input2.txt
